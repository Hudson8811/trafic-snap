$(document).ready(function () {
  ...
  $('.js-button-animation').hover(
    function () {
      $(this).parent().removeClass('button-animation-1').removeClass('button-animation-2').removeClass('button-animation-3');
      var random=Math.floor(Math.random() * Math.floor(3))+1; //1, 2 или 3
      $(this).parent().addClass('button-animation-'+random).addClass('button-animation-visible');
    }, function () {
